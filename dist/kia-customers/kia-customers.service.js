...
exports.KiaCustomersService = void 0;
const common_1 = require("@nestjs/common");
const mongoose_1 = require("@nestjs/mongoose");
const kiaCustomer_schema_1 = require("../Schemas/kiaCustomer.schema");
const mongoose = require("mongoose");
let KiaCustomersService = class KiaCustomersService {
    constructor(kiaCustomerModel) {
        this.kiaCustomerModel = kiaCustomerModel;
    }
    async create(createKiaCustomerDto) {
        try {
    ...
    async update(id, updateKiaCustomerDto) {
        try {
            const userData = {
...
exports.KiaCustomersService = KiaCustomersService;
exports.KiaCustomersService = KiaCustomersService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, mongoose_1.InjectModel)(kiaCustomer_schema_1.KiaCustomer.name)),
    __metadata("design:paramtypes", [mongoose.Model])
], KiaCustomersService);
//# sourceMappingURL=kia-customers.service.js.map