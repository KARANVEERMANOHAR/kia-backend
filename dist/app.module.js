...
const kia_customers_module_1 = require("./kia-customers/kia-customers.module");
...
exports.AppModule = AppModule = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            mongoose_1.MongooseModule.forRoot(process.env.ENVIRONMENT === 'local'
                ? `${process.env.MONGO_LOCAL_DB_URL}`
                : `${process.env.MONGO_PRODUCTION_DB_URL}`),
            dealers_module_1.DealersModule,
            kia_customers_module_1.KiaCustomersModule,
        ],
